...
/**
 * _strlen - the program returns length of a str
...
/**
 * _strcmp - the program performs lexicogarphic comparison of two strangs.
 * @s1: first str
 * @s2: second str
 *
...
/**
 * starts_with - the program checks if needle starts with haystack
